...
int main()
{
    ...
    while (!glfwWindowShouldClose(window.self))
    {
        ...
        setShaderVec3(shaderCubo, "lightPos", 0.25f, -0.25f, 0.0f);
        ...
        setShaderVec3(shaderPiramide, "lightPos", -0.55f, 0.0f, 1.0f);
        ...
        setShaderVec3(shaderPrisma, "lightPos", 0.0f, 0.0f, 0.6f);
